...
const initialState = {
    ...
    keys: {
        psent: {
			fnGetOptionAccountDept: "1fe12c03-0af2-11f1-a2d7-005056bed060"
		},
    }
}
...
export const { openOffcanvas, closeOffcanvas, fnShowPanels, fnHidePanels } = dynamicurlSlice.actions;
